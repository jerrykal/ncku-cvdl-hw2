...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.lblQ5Img = QtWidgets.QLabel(self.groupBox_5)
        self.lblQ5Img.setGeometry(QtCore.QRect(240, 40, 401, 261))
        self.lblQ5Img.setText("")
        self.lblQ5Img.setObjectName("lblQ5Img")
        self.lblResNetPred = QtWidgets.QLabel(self.groupBox_5)
        self.lblResNetPred.setGeometry(QtCore.QRect(400, 310, 58, 16))
        self.lblResNetPred.setText("")
        self.lblResNetPred.setObjectName("lblResNetPred")
        self.label = QtWidgets.QLabel(self.groupBox_5)
        self.label.setGeometry(QtCore.QRect(330, 310, 71, 16))
